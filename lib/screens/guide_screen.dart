...
class GuideScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String tip = "✔️ ${spotName}에서 인생샷을 찍는 팁!\n\n"
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text("📸 $spotName", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () => Navigator.pushNamed(context, '/camera', arguments: spot),
